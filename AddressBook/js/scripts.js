...
function Contact(firstName, lastName, phoneNumber, email, mailingAddress, billingAddress) {
  this.firstName = firstName
  this.lastName = lastName
  this.phoneNumber = phoneNumber
  this.email = email
  this.mailingAddress = setupAddress(mailingAddress)
  this.billingAddress = setupAddress(billingAddress)
}
